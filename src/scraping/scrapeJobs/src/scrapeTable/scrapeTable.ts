...
export const scrapeTable = async (page: Page, progressReporter: ProgressReporter):Promise<IJobRowResponse[]> => {
    ...
    progressReporter.nextStep("Scraping individual job pages", firstPage.totalResults);
    return out;
}